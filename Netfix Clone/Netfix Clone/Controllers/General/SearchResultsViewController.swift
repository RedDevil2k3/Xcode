...
class SearchResultsViewController: UIViewController {
    ...
    public var titles: [Title] = [Title]() //initialized as empty //public since its being used in SearchViewController for search
    
    public weak var delegate: SearchResultsViewControllerDelegate?
    
    public let searchResultsCollectionView: UICollectionView = { //public since its being used in SearchViewController for search
